    ...
    <div class="container">
        ...
        <form method="get" action="meals/filter">
            <div class="form-group">
                <label for="dateTime" class="col-form-label"><spring:message code="meal.startDate"/></label>
                <input class="form-control" type="date" name="startDate" value="${param.startDate}">
            </div>
            <div class="form-group">
                <label for="dateTime" class="col-form-label"><spring:message code="meal.endDate"/></label>
                <input class="form-control" type="date" name="endDate" value="${param.endDate}">
            </div>
            <div class="form-group">
                <label for="dateTime" class="col-form-label"><spring:message code="meal.startTime"/></label>
                <input class="form-control" type="time" name="startTime" value="${param.startTime}">
            </div>
            <div class="form-group">
                <label for="dateTime" class="col-form-label"><spring:message code="meal.endTime"/></label>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="description" value="${meal.description}" size=40
                               name="description" required>
                    </div>
                    <div class="form-group">
                        <label for="calories" class="col-form-label"><spring:message code="meal.calories"/>:</label>
                        <input type="number" class="form-control" id="calories" value="${meal.calories}" name="calories"
                               required>
                    </div>
                </form>
            </div>
